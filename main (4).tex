...
\begin{titlepage}
  ...
  \begin{tabular}{@{}lr@{}}
    LaTeX raporu + derlenmiş PDF teslimi & \textbf{+5 puan} \\[0.25em]
    GitHub deposu (açık, README ile) & \textbf{+5 puan} \\
    \multicolumn{2}{@{}l@{}}{\footnotesize\url{https://github.com/yahya308/verimadenciligifinal}} \\[0.25em]
    Demo videosu (\texttt{sunumvideo.mp4}, yerel kayıt) & \textbf{+3 puan} \\[0.4em]
    \hline\\[-0.6em]
    \textit{Talep edilen toplam bonus} & \textit{\textbf{+13 puan}} \\
  \end{tabular}\\[0.3em]
...
\texttt{IBK.txt}, \texttt{sunumvideo.mp4}, \texttt{README.txt}.
